...
public static class DbInitializer
{
    public static async Task Seed(ApplicationDbContext context)
    {
        ...
        context.MenuItems.AddRange(
            // Hooligan Buns
            new MenuItem { MerchantId = hooligans.Id, Name = "Classic Bun", Price = 42.00m, Description = "Chips with Cheddar cheese, egg & ham", Category = "Hooligan Buns", IsAvailable = true, ImageUrl = "https://scontent-jnb2-1.xx.fbcdn.net/v/t39.30808-6/672674693_1483187980264273_4107318391084042444_n.jpg?stp=c342.0.1128.1128a_dst-jpg_s206x206_tt6&oh=00_Af13ITxBrTldlGrStf293ktUAO6rZQAmfiWkRZb0y3v8IA&oe=69EDD01E" },
            ...
            new MenuItem { MerchantId = hooligans.Id, Name = "Beef Burger Bun", Price = 60.00m, Description = "100g beef patty with cheddar cheese, egg & ham", Category = "Hooligan Buns", IsAvailable = true, ImageUrl = "https://scontent-jnb2-1.xx.fbcdn.net/v/t39.30808-6/654263889_1460309155885489_4581901056079659432_n.jpg?stp=dst-jpg_s960x960_tt6&oh=00_Af2aFuMyaSPSjFmzaFks4XHXTg5ypsW8dzCutMtgWFR2gQ&oe=69EDCE9A" },
            new MenuItem { MerchantId = hooligans.Id, Name = "Chicken Fillet Bun", Price = 65.00m, Description = "Crumbed chicken fillet with egg, cheddar & mozzarella cheese", Category = "Hooligan Buns", IsAvailable = true, ImageUrl = "https://scontent-jnb2-1.xx.fbcdn.net/v/t39.30808-6/672047501_1483191270263944_8232360528544140135_n.jpg?stp=c643.0.755.755a_dst-jpg_s206x206_tt6&oh=00_Af3qRDLTXLIcmYqVtVC8MfYliWAM1OwgQZkdjp66_Mz0oQ&oe=69EDC8E8" },
            new MenuItem { MerchantId = hooligans.Id, Name = "Double Beef Burger", Price = 85.00m, Description = "Double 100g beef patty with cheddar cheese, egg & ham", Category = "Hooligan Buns", IsAvailable = true, ImageUrl = "https://scontent-jnb2-1.xx.fbcdn.net/v/t39.30808-6/672213540_1483188326930905_2175191294999634513_n.jpg?stp=c436.0.306.306a_dst-jpg_s206x206_tt6&oh=00_Af33n8iWmCyo9LhdJmu3Knx4GaUJ_3M40G783fhrRJg-oA&oe=69EDE24D" },
